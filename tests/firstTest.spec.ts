...
test('User facing locators', async ({page}) => {
    ...
    //Add 'data-testid' attribute <-- Reserved by playwright
    await page.getByTestId('yourId')
...
test('Location child elements', async({page}) => {
    ...
    //By index. Not preferable. Avoid doing this.
...
test('Locate parent elements', async ({page}) => {
    ...
    //Go one level up. Not recommended! AVOID!
